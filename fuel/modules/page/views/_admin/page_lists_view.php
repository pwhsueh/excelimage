				       ...
				       <select name="search_category" id="category">
				       	<option value="all">不拘</option>
							...
							<?php   foreach($category as $key=>$rows):?>
								<option value="<?php echo $rows->code_id ?>" <?php if ($search_category == $rows->code_id): ?>
									selected
			...
			<table class="table table-striped table-advance table-hover">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if (isset($rows->image_path) && !empty($rows->image_path)): ?>
								<img style="width:150px" src="<?php echo site_url()."assets/".$rows->image_path?>" />
							<?php endif ?>
						</td>  
						<td>
